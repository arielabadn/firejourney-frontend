...
function Footer() {
  ...
  const facebookEmail = {email: "", subject: "firejourneyapp_facebook", message: "User clicked facebook page button in footer"};
  ...
  return (
    <footer className="bg-gray-800 md:flex md:items-center md:justify-between shadow rounded-lg p-4 md:p-6 my-1 mx-1 mt-4">
