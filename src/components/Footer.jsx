...
function Footer() {
  ...
  return (
    <footer className="bg-gray-800 md:flex md:items-center md:justify-between shadow rounded-lg p-4 md:p-6 my-1 mx-1 mt-4">
        <span className="text-sm text-gray-400 sm:text-center dark:text-gray-500">© {year} <a href="/" className="hover:underline">FIRE Journey</a>. All Rights Reserved.</span>
        ...
        <div className="flex sm:justify-center space-x-6">
            <a href="https://www.facebook.com/firejourneyapp" target="_blank" className="text-gray-400 hover:text-gray-300">
